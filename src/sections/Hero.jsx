import { shoes, statistics } from '../constants'; // Added missing semicolon
...
const Hero = () => {
  ...
  return (
    ...
    >
      <div
        className="relative flex flex-col justify-center items-start w-full max-xl:padding-x pt-28 xl:w-2/5"
      >
